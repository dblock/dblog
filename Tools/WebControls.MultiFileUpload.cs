...
namespace DBlog.Tools.WebControls // Wilco.Web.UI.WebControls
{
    ...
    public class MultiFileUpload : WebControl
    {
        ...
        public string FileCssClass
        {
            get
            {
                return Web.ViewState<string>.GetViewStateValue(this.ViewState, "FileCssClass", String.Empty);
            }
            set
            {
        ...
        public string InputCssClass
        {
            get
            {
                return Web.ViewState<string>.GetViewStateValue(this.ViewState, "InputCssClass", String.Empty);
            }
            set
            {
