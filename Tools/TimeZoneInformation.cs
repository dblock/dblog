...
namespace DBlog.Tools
{
    ...
    public class TimeZoneInformation
    {
        ...
        /// <param name="tz">UTC bias</param>
        /// <returns>True if successfully parsed.</returns>
        public static bool TryParseTimezoneRegionToTimeSpan(string offset, out TimeSpan tz)
        {
            if (offset.StartsWith("UTC"))
            {
                offset = offset.Substring("UTC".Length, offset.Length - "UTC".Length);
            }
            ...
            string[] parts = offset.Split(".:".ToCharArray(), 2);
