...
SELECT
   [Comment].*
 , ''Entry'' AS [Type]
 , [EntryComment].Entry_Id AS [Parent_Id]
FROM 
   [Comment]
 , [EntryComment]
WHERE
   [Comment].Comment_Id = [EntryComment].Comment_Id
UNION ALL
SELECT
   [Comment].*
 , ''Gallery'' AS [Type]
 , [GalleryComment].Gallery_Id AS [Parent_Id]
FROM 
   [Comment]
 , [GalleryComment]
WHERE
   [Comment].Comment_Id = [GalleryComment].Comment_Id
UNION ALL
SELECT
   [Comment].*
 , ''Image'' AS [Type]
 , [ImageComment].Image_Id AS [Parent_Id]
FROM 
   [Comment]
 , [ImageComment]
WHERE
   [Comment].Comment_Id = [ImageComment].Comment_Id
' 
GO
SET ANSI_NULLS ON
GO
